...
/**
 * Created by hongenit on 2016/12/10.
 */
...
public class ImageLoader {
    ...
    public void showRoomAvatr(Context context, String uri,
                              ImageView imageView) {
        Glide.with(context).load(uri)
                .diskCacheStrategy(DiskCacheStrategy.RESULT)
                .error(R.drawable.defualt_room_avatar)
                .placeholder(R.drawable.defualt_room_avatar).centerCrop()
                .into(imageView);
